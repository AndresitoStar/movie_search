        ...
        return ButtonBar(
          ...
          children: [
            if (model.social?.facebookId != null)
              IconButton(
                onPressed: () => launch('https://www.facebook.com/${model.social!.facebookId}'),
                icon: Icon(MyIcons.facebook, color: Color(0xff4267b2)),
              ),
            if (model.social?.instagramId != null)
              IconButton(
                onPressed: () => launch('https://www.instagram.com/${model.social!.instagramId}'),
                icon: Image.asset('assets/images/instagram.png', width: 24),
              ),
            if (model.social?.twitterId != null)
              IconButton(
                onPressed: () => launch('https://www.twitter.com/${model.social!.twitterId}'),
