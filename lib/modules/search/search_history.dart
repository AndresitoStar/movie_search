...
class SearchHistoryViewModel extends StreamViewModel<List<String>> {
  @override
  Stream<List<String>> get stream => SharedPreferencesHelper.getInstance().streamForSearchHistory;
}
...
class SearchHistoryView extends StatelessWidget {
  ...
  const SearchHistoryView({Key? key, required this.onTap}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<SearchHistoryViewModel>.reactive(
      builder: (context, model, child) => model.data != null && model.data!.isNotEmpty
          ? ListView.separated(
