...
class DiscoverFilterView extends ConsumerWidget {
  DiscoverFilterView({super.key, this.scrollController});
    ...
    await showModalBottomSheet(
      ...
      builder: (context) {
        return DraggableScrollableSheet(
          initialChildSize: 0.8, // 80% al abrir
          minChildSize: 0.4, // mínimo al hacer drag hacia abajo
          maxChildSize: 1.0, // hasta 100%
          expand: false,
          builder: (context, scrollController) {
            return Container(
              ...
              child: DiscoverFilterView(scrollController: scrollController),
            );
          },
        );
      },
